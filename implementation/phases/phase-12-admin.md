...
## Epic 12.1: User Profile & Admin API

### Feature 12.1.1: User CRUD & Restrictions
...
### Feature 12.1.2: Controller & Routes
...
## Epic 12.2: Global Configuration

### Feature 12.2.1: App Config Model
- [ ] Create `models/app-config.model.js`
- [ ] Singleton pattern for global settings (e.g. `maxWorkspaces`, maintenance mode)

### Feature 12.2.2: Config API
- [ ] `GET /api/v1/config`
- [ ] `PATCH /api/v1/config` (Admin only)

---

## Epic 12.3: System Analytics & Insights

### Feature 12.3.1: Admin Insights API
